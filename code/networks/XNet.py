...
class XNet(nn.Module):
    ...
    def forward(self, input1, input2):
        # code
        # branch1
        x1_1 = self.b1_1_1(input1) # c  1 -> 64

        x1_2 = self.b1_1_2_down(x1_1)
        x1_2 = self.b1_2_1(x1_2) # c  64 -> 128

        x1_3 = self.b1_2_2_down(x1_2)
        x1_3 = self.b1_3_1(x1_3) # c  128 -> 256
        ...
        x1_5_2_same = self.b1_5_2_same(x1_5_1)  # c 1024 w h 16 
        # branch2
        ...
        x2_5_2_same = self.b2_5_2_same(x2_5_1) # c 1024 w h 16
...
#     # print(output)
#     print(output1.shape)
#     print(output2.shape) # (2, 10, 256, 256)


# if __name__ == '__main__':
    
#     model = XNet(1, 10)
#     input1 = torch.randn(2, 1, 112, 112)
#     input2 = torch.randn(2, 1, 112, 112)
    
#     model.cuda()
#     input1 = input1.cuda()
#     input2 = input2.cuda()
#     x1_1, x2_1 = model(input1,input2) 
#     print(x1_1.shape) # [2, 10, 112, 112]
